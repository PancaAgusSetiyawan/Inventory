    ...
    Private Sub ButtonSave_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonSave.Click
        ...
        Else
            ...
            Try
                ...
                Else
                    objCommand.Dispose()
                    strSQL = "INSERT INTO TBL_PENGELUARAN (NO_PENGELUARAN,TGL_PENGELUARAN,KD_BRG,QTY) VALUES('" & txtNomor.Text & "','" & txtTgl.Text & "','" & cboBarang.Text & "','" & CDbl(txtQty.Text) & "')"
                    objCommand = New OleDbCommand(strSQL, myCon)
                ...
                If blnStock Then
                    strSQL = "UPDATE TBL_STOCK SET QTY_OUT = " & dblNewOut & ",QTY_AKHIR = " & dblNewAkhir & " WHERE KD_BRG ='" & cboBarang.Text & "'"
                    objCommand = New OleDbCommand(strSQL, myCon)
                    objCommand.ExecuteNonQuery()
                Else
                    strSQL = "INSERT INTO TBL_STOCK (KD_BRG,QTY_IN,QTY_OUT,QTY_AKHIR) VALUES('" & cboBarang.Text & "'," & CDbl(txtQty.Text) & "," & CDbl(txtOut.Text) & "," & CDbl(txtAkhir.Text) & ")"
                    objCommand = New OleDbCommand(strSQL, myCon)
                    objCommand.ExecuteNonQuery()
                End If
            Catch ex As Exception
    ...
    Private Sub ButtonEdit_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButtonEdit.Click
        ...
        Else
            ...
            Else
                ...
                Try
                    myCon.Open()
                    strSQL = "UPDATE TBL_PENGELUARAN SET KD_BRG = '" & cboBarang.Text & "', QTY = '" & CDbl(txtQty.Text) & "' WHERE NO_PENGELUARAN = '" & txtNomor.Text & "'"
                    objCommand = New OleDbCommand(strSQL, myCon)
                    If objCommand.ExecuteNonQuery Then
